...
5.  **Overhead Sistem**: Penyangga yang dipesan (20%) untuk OS, tampilan, dan overhead kerangka kerja.
...
7.  Lihat estimasi **Parameter Maksimum** dan rincian memori yang mendetail.
...
-   **Estimasi Model**: Menyarankan arsitektur model yang dikenal terdekat (misalnya, Llama 3, Mistral, Qwen, DeepSeek) yang sesuai dengan parameter yang dihitung.
