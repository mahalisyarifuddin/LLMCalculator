...
-   **One Dual-Purpose Context Slider**: The logarithmic **Context Window / Active Working Context** slider estimates one active local inference context without a redundant mode toggle.
